...
Automatisk daglig epost med de viktigste AI-nyhetene, generert av Gemini AI og levert via Gmail.

**Helt gratis å kjøre.**

---

## Slik setter du det opp (ca. 30 min)
...
### Steg 5 – Legg inn hemmelige nøkler i GitHub
...
| Gemini 1.5 Flash API | Gratis (1 500 kall/dag inkludert) |
| Gmail SMTP | Gratis |
| **Totalt** | **0 kr** |
